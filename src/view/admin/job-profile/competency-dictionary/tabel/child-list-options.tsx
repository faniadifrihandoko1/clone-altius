...
import { ModalEditChildCompetencyDictionary } from "../modal/edit-child";

interface ListOptionsPropsType {
  data: any;
}

export const ChildListOptions = (props: ListOptionsPropsType) => {
  const { data } = props;
  ...
  return (
    <Box display="flex" gap={0.5} alignItems="center" justifyContent="center">
      ...
      {openEdit && (
        <ModalEditChildCompetencyDictionary
          open={openEdit}
          toggle={togleEdit}
          id={data?.Id}
        />
