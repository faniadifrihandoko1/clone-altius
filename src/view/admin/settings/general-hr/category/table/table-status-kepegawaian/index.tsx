...
import { ModalAddStatusKepegawaian } from "../../add/add-status-kepegawaian";
import { rows, useTableColumns } from "./list-columns";

export const ListStatusKepegawaian = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddStatusKepegawaian open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
