...
export function useTableColumns() {
  const t = useTranslations("general-hr.category.tables.terminationReason");
  const tableHead = t.raw("tableHead");

  return useMemo(() => {
    if (!Array.isArray(tableHead)) {
      console.warn("Table head not found for module: terminationReason");
      return [];
    }
...
export const rows = [
  { id: 1, name: "Mengundurkan diri" },
  { id: 2, name: "Pensiun" },
  { id: 3, name: "Diberhentikan terhormat" },
  { id: 4, name: "Diberhentikan tidak terhormat" },
];
