...
import { ModalAddJenisHubunganKerabat } from "../../add/add-jenis-hubungan-kerabat";
import { rows, useTableColumns } from "./list-columns";

export const ListJenisHubunganKerabat = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddJenisHubunganKerabat open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
