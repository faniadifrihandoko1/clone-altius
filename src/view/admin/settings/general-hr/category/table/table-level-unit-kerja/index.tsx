...
import { ModalAddLevelUnitKerja } from "../../add/add-level-unit-kerja";
import { rows, useTableColumns } from "./list-columns";

export const ListLevelUnitKerja = () => {
  ...
  return (
    ...
    >
      ...
      <DataGrid
        ...
        pageSizeOptions={[10]}
      />
      {openAdd && <ModalAddLevelUnitKerja open={openAdd} toggle={toggleAdd} />}
    </Box>
  );
};
