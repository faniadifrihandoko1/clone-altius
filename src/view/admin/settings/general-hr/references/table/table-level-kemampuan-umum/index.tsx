...
import { ModalAddLevelKemampuanUmum } from "../../add/add-level-kemampuan-umum";
import { rows, useTableColumns } from "./list-columns";

export const ListLevelKemampuanUmum = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddLevelKemampuanUmum open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
