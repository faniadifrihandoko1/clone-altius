...
import { ModalAddKeahlianPegawai } from "../../add/add-keahlian-pegawai";
import { rows, useTableColumns } from "./list-columns";

export const ListKeahlianPegawai = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && <ModalAddKeahlianPegawai open={openAdd} toggle={toggleAdd} />}
    </Box>
  );
};
