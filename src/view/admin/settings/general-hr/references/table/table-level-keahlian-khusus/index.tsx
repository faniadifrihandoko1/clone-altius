...
import { ModalAddLevelKeahlianKhusus } from "../../add/add-level-keahlian-khusus";
import { rows, useTableColumns } from "./list-columns";

export const ListLevelKeahlianKhusus = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddLevelKeahlianKhusus open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
