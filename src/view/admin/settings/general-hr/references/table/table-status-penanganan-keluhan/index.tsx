...
import { ModalAddStatusPenangananKeluhan } from "../../add/add-status-penanganan-keluhan";
import { rows, useTableColumns } from "./list-columns";
import { useTranslations } from "next-intl";

export const ListStatusPenangananKeluhan = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddStatusPenangananKeluhan open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
