...
import { ModalAddJenisAsetPegawai } from "../../add/add-jenis-aset-pegawai";
import { rows, useTableColumns } from "./list-columns";

export const ListJenisAsetPegawai = () => {
  ...
  return (
    ...
    >
      ...
      />
      {openAdd && (
        <ModalAddJenisAsetPegawai open={openAdd} toggle={toggleAdd} />
      )}
    </Box>
  );
};
